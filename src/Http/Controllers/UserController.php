...
use Vendor\PhpMa\Core\Authenticator;
use Vendor\PhpMa\Core\Middleware\Auth;
use Vendor\PhpMa\Core\Session;
use Vendor\PhpMa\Http\Forms\FormValidation;
use Vendor\PhpMa\Http\Utility\Utilities;
use Vendor\PhpMa\Mail\ForgotPasswordMail;
use Vendor\PhpMa\Mail\VerificationMail;
